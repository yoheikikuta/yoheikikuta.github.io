...
Ubie Disovery においては [Holacracy](https://yoheikikuta.github.io/ubie_discovery_org_dev_as_software_dev/) を採用しているので、このような生産性向上ツールの全体管理や組織装着に責務を持つ役割を作り、自分や他の開発者をその役割にアサインしている（これとは別に Large Language Model を使った新しい価値の創造や事業戦略への反映などを進めているチームもあるが、それは今回の生産性向上の話とは別なので割愛）。
